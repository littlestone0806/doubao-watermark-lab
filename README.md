...
- **应用内自动更新**：启动时自动检查 GitHub Releases 新版本（Windows 安装版后台下载、重启即升级；macOS 发现新版本会弹窗提示，可一键下载安装包并打开，拖入「应用程序」替换即可；便携版请前往发布页下载）
...
3. 勾选要处理的任务，点击处理设置面板底部的"开始批量处理"。任务期间保持豆包窗口开启。
